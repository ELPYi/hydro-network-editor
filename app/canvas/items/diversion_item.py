"""Diversion graphics item: blue dashed arrow line between two Nodes."""
from __future__ import annotations

import math

from PyQt6.QtCore import QLineF, QPointF, QRectF, Qt
from PyQt6.QtGui import QBrush, QColor, QFont, QPainter, QPainterPath, QPainterPathStroker, QPen, QPolygonF
...
class DiversionItem(QGraphicsItem):
    """Blue dashed directed line (with arrowhead) connecting two NodeItems."""
